...
--Lowercase transform removed
select replace((col3), '._', '_'),'Copy ' + replace(replace(replace((col3), '"', '"'),'._','.'),'dbo','public') + char(13) + 'From ' + char(39) + @folderPath + replace((col3), '"', '') + '.csv' + char(39) + ' DELIMITER ' + char(39) + '~' + char(39) + ' null as ' + char(39) + 'null' + char(39) + '  encoding ' + char(39) + 'windows-1251' + char(39) + ' CSV;' + char(13) + 'select 1;' + char(13)
