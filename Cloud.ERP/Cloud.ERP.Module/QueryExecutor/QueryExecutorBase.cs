...
namespace Cloud.ERP.Module.QueryExecutor
{
    public abstract class QueryExecutorBase
    {
        ...
        public void Load(QueryExecutorBase queryExecutor)
        {
            ExecutorBase.Add(queryExecutor);
        }

        public void Remove(QueryExecutorBase queryExecutor)
        {
            ExecutorBase.Remove(queryExecutor);
        }
    }
}
